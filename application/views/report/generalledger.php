...
<section>
  <div class="container-fluid">
    <!-- Page Header-->
    <header> 
          <h1 class="h3 display"><?= lang('ui_generalledger')?> </h1>
      </tr>
    </header>
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <div class = "row">
              <div class="col-sm-6">
                <h4><?= lang('ui_generalledger')?></h4>
              </div>
            </div>
          </div>
          <div class="card-body">                
                <form method = "post" action = "<?= base_url('reports/generalledger_pdf');?>" target="_blank">
                    <div class = "row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group has-success">
                                    ...
                                    <input hidden id = "chartofaccountid" type="text" class="form-control" name = "chartofaccountid" value="">
                                    <input id = "chartofaccountname" type="text" class="form-control custom-readonly"  value="" readonly required>
