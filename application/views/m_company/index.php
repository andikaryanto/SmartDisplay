...
<section>
  <div class="container-fluid">
    <!-- Page Header-->
    <header> 
          <h1 class="h3 display"><?= lang('ui_master_company')?> </h1>
      </tr>
    </header>
    <div class="row">
          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-sm-6 text-right">
                <a href="<?= base_url('office/mcompany/add')?>"><i class = "fa fa-plus"></i> Tambah</a>
              </div>
            </div>
          </div>
          <div class="card-body">
  ...
  function dataTable(){
    ...
    var table = $('#tableProvince').DataTable();
     ...
     table.on( 'click', '.edit', function () {
        ...
        var id = $tr.attr('id');
        window.location = "<?= base_url('office/mprovince/edit/');?>" + id;
     } );
     ...
     table.on( 'click', '.delete', function (e) {
        ...
        deleteData(data[0], function(result){
          if (result==true)
          {
            ...
            $.ajax({
              type : "POST",
              url : "<?= base_url('office/mprovince/delete/');?>",
              data : {id : id},
