    ...
    <section class="dashboard-counts section-padding ">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-12">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase"><?= lang('info_contact_your_admin')?></strong><span><?= lang('info_page_forbidden') ?></span>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="wrapper count-title d-flex">
                <div class="icon"><strong class="text-uppercase"><a href="<?= base_url('home')?>"><i class="icon-home"></i> <?= lang('info_back_to_home')?></a></strong></div>
              </div>
            </div>
          </div>
        </div>
