          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <!-- <a href="<?= base_url('mplayer')?>"><i class = "fa fa-table"></i> Data</a> -->
              </div>
            </div>
          </div>
          <div class="card-body">                   
            <form method = "post" action = "<?= base_url('mplayer/addsave');?>">
              ...
              <div class="form-group">
                <div class = "required">
                  <label><?= lang('ui_groupplayer')?></label>
              ...
              <div class="form-group">       
                ...
                <a href="<?= base_url('mplayer')?>" value="<?= lang('ui_cancel')?>" class="btn btn-primary"><?= lang('ui_cancel')?></a>
              </div>
            </form>
          </div>
        </div>
  ...
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="groupUserModalLabel" class="modal-title"><?= lang('ui_groupplayer')?></h5>
