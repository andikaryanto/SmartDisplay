          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <a href="<?= base_url('mtickersetting/add')?>"><i class = "fa fa-plus"></i> Tambah</a>
              </div>
            </div>
          </div>
          <div class="card-body">
              ...
              <table id = "tableGroupUser" style="width: 100%;" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" role="grid">
                <thead class=" text-primary">
                  <tr role = "row">
                    <!-- <th># </th> -->
                    <th><?=  lang('ui_name')?></th>
                    <th><?=  lang('ui_backgroundcolor')?></th>
                    <th><?=  lang('ui_fontcolor')?></th>
                    <th><?=  lang('ui_height')?></th>
     ...
     table.on( 'click', '.delete', function (e) {
        ...
        deleteData(data[0], function(result){
          if (result==true)
          {
            ...
            $.ajax({
              type : "POST",
              url : "<?= base_url('mtickersetting/delete/');?>",
              data : {id : id},
